...
import { resolveEnforcementLevel, resolveLayeredEnforcement, deriveSwitchesFromEnforcement, } from './enforcement.js';
export { resolveEnforcementLevel, resolveLayeredEnforcement, deriveSwitchesFromEnforcement, };
const toSettingsNamespace = (value) => {
...
export const SUBAGENT_DIRECTOR_SETTINGS_NAMESPACE = toSettingsNamespace('subagent-director');
...
export function installDirectorSettings(ctx, entry, hooks) {
    ...
    const installFn = dshSettings.installSettingsSection;

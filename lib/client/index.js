window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* path ops, and failures return a localized message. */
		function RoleCard({ id, role, isDefault, routes, tools, t, onSave, onDelete, onSetDefault }) {
		...
		*/
		...
		function Loaded({ injected }) {
			...
			const switches = deriveSwitchesFromEnforcement(resolveEnforcementLevel(section));
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: sectionWidth,
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrchestrateInterceptCard, {
						controller,
						writable,
		...
		function OrchestrateInterceptCard({ controller, writable, interceptTools, roundIntercept, savedRoundIntercept, t }) {
			...
			const onToggleIntercept = async (value) => {
				...
				try {
					if (!value) {
						const message = await controller.setInterceptSwitches({ orchestrateInterceptTools: false });
						if (message !== void 0) setFailure(message);
					} else {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
							...
							children: t("interceptCardHeading")
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: t("interceptToolsLabel")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									color: token.labelSecondary,
									fontSize: 12,
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: t("interceptYes")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: !interceptTools ? primaryButtonStyle : ghostButtonStyle,
									disabled: !writable || busy,
									onClick: () => void onToggleIntercept(false),
									children: t("interceptNo")
								})]
							})]
						})
					}),
					interceptTools ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							marginTop: 4,
							padding: "10px 12px",
							background: token.bgLayer1,
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: t("interceptRoundLabel")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									color: token.labelSecondary,
									fontSize: 12,
		...
		*/
		...
		//#endregion
		//#region src/client/SubagentOrchestrateButton.tsx
		/**
		...
		*/
		function nextOrchestrateCommand(active) {
		...
		*/
		async function executeOrchestrateToggle(params) {
			const { sessionId, active, disabled, executeCommand, isExecutingRef, callSeqRef, currentSessionRef, aliveRef, setBusy, setLastError } = params;
			...
			setLastError(null);
			try {
				const err = await executeCommand(targetSession, nextOrchestrateCommand(active));
				if (aliveRef.current && currentSessionRef.current === targetSession && callSeqRef.current === seq) {
					if (err) setLastError(err);
				}
			} catch (e) {
				if (aliveRef.current && currentSessionRef.current === targetSession && callSeqRef.current === seq) setLastError(e instanceof Error ? e.message : String(e));
			} finally {
				if (callSeqRef.current === seq) {
					isExecutingRef.current = false;
					if (aliveRef.current && currentSessionRef.current === targetSession) setBusy(false);
				}
			}
		}
		function SubagentOrchestrateButton(props) {
			...
			const currentSessionRef = (0, react.useRef)(sessionId);
			const isExecutingRef = (0, react.useRef)(false);
			const callSeqRef = (0, react.useRef)(0);
			(0, react.useEffect)(() => {
			...
			const disabled = busy || !Boolean(executeCommand);
			const toggle = () => executeOrchestrateToggle({
				sessionId,
				active,
				disabled,
				executeCommand,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				style: {
					...
					border: lastError ? "1px solid #e05252" : active ? "1px solid " + token.accent : "1px solid " + token.border,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M4 6v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6" }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M8 10v0" })
					]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("useSubagents") })]
			});
		}
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			const orchestrateToggleInjected = (sessionId) => ({ executeCommand: async (sid, commandLine) => {
				const commands = ctx.get("remote")?.commands ?? ctx.remote?.commands;

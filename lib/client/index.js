	...
	factory: (require) => {
		...
		*/
		...
		function DefaultModelRow({ controller, routes, modelSelectionEnabled, writable, current, enforcement, t }) {
			...
			const [enforcementBusy, setEnforcementBusy] = (0, react.useState)(false);
			const [enforcementFailure, setEnforcementFailure] = (0, react.useState)(void 0);
			const toggleEnforcement = async () => {
				const next = enforcement === "strict" ? "lenient" : "strict";
				setEnforcementBusy(true);
				setEnforcementFailure(void 0);
				try {
					const message = await controller.setEnforcement(next);
					if (message !== void 0) setEnforcementFailure(message);
				} finally {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					enforcementFailure !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							color: token.danger,
							fontSize: 12
						},
						children: enforcementFailure
					}) : null,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: enforcement === "strict" ? t("enforcementToggleOn") : t("enforcementToggleOff")
						})]
					})
				]
			});

 ...
 */
export function nextOrchestrateCommand(active) {
 ...
 */
export async function executeOrchestrateToggle(params) {
    ...
    if (disabled || !executeCommand || !sessionId || isExecutingRef.current)
        return;
...
export function SubagentOrchestrateButton(props) {
    ...
    return (_jsxs("button", { type: "button", onClick: () => void toggle(), disabled: disabled, title: title, "aria-pressed": active, style: {
            display: 'inline-flex',
            alignItems: 'center',
            gap: 4,
            height: 24,
        ...
        }, children: [_jsxs("svg", { viewBox: "0 0 16 16", width: "12", height: "12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [_jsx("circle", { cx: "4", cy: "4", r: "2" }), _jsx("circle", { cx: "12", cy: "4", r: "2" }), _jsx("circle", { cx: "8", cy: "12", r: "2" }), _jsx("path", { d: "M4 6v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6" }), _jsx("path", { d: "M8 10v0" })] }), _jsx("span", { children: t('useSubagents') })] }));
}
/**
 ...
 */
export function createOrchestrateButtonController(initialProps) {
    ...
    const getActive = () => {
        const orchestrate = props.useProjection('orchestrate');
...
//# sourceMappingURL=SubagentOrchestrateButton.js.map
...
export declare function validateRoleIdFormat(id: string): boolean;
/** Validate role id is unique among existing roles, allowing currentId during edit. */
export declare function validateRoleIdUnique(id: string, existing: ReadonlySet<string> | Iterable<string>, currentId?: string): boolean;
/** Resolve final role id: use customId if provided, otherwise auto-derive from name. */
export declare function resolveRoleId(customId: string | undefined, name: string, existing: ReadonlySet<string>, prefix?: string): string;
 ...
 */
export declare function validateRoleSubmission(idInput: string | undefined, displayName: string, existing: ReadonlySet<string>, currentId?: string, description?: string): RoleValidationResult;
 ...
 */
export declare function renameRoleOps(oldId: string, newId: string, before: StoredRole | undefined, draft: RoleDraft, defaultRole?: string): SettingsPathOpView[];
/**

...
export declare const AGENT_TEAM_EVENT_TYPE = "agent-team/change";
/** Accepted mode values. */
export declare const ORCHESTRATE_VALID_MODES: readonly ['on', 'off', 'agent-team'];
 ...
 * @param toolName - the configured model-facing delegation tool name.
 */
export declare function renderOrchestratorSection(settings: SubagentDirectorSettings, toolName: string, enforcement: OrchestrateEnforcement): string;
/**
 * Build the data-independent framing of the Agent-Team Lead prompt.
 */
export declare function buildAgentTeamFrame(enforcement?: OrchestrateEnforcement): string;
/**
 * Assemble the full Agent-Team prompt (framing + dynamic role list).
 */
export declare function renderAgentTeamPrompt(settings: SubagentDirectorSettings, toolName: string, enforcement?: OrchestrateEnforcement): string;
/**
 * Full agent-team prompt when roles are configured, else the short unavailable notice.
 */
export declare function renderAgentTeamSection(settings: SubagentDirectorSettings, toolName: string, enforcement: OrchestrateEnforcement): string;
/**
